...
class application {
	include application::gitclonedb, application::gitcloneapp, application::dbcreate, application::dbrestore, application::php, application::symlink, application::editfor_cleanurl, application::editfor_documentroot
}
